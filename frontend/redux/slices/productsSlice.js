...
export const fetchProductsByFilters = createAsyncThunk("products/fetchByFilters",
    async ({
        ...
        const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/products?${query.toString()}`);
...
export const updateProduct = createAsyncThunk("products/updateProduct", async({ id, productData })=> {
    const response = await axios.put(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/products/${id}`, productData,
        {
            headers: {
